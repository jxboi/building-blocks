...
export function WorkspaceSwitcher({ workspace }: { workspace: string }) {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button
          variant="ghost"
          className="h-auto w-full justify-start gap-2 px-1.5 py-1.5 text-sidebar-foreground hover:bg-sidebar-accent/70 hover:text-sidebar-accent-foreground"
        >
          ...
          <span className="min-w-0 flex-1 text-left">
            ...
            <span className="block truncate text-xs leading-3.5 text-sidebar-foreground/42">{selected.organisation}</span>
          </span>
